...
from langchain.llms import CTransformers
#function to get response for LLAma 2  Model

def getLLamaresponse(input_text,no_words,blog_style):
    
    ## Call LLama2 model which was already downloded from hugging face
    llm=CTransformers(model=r"models\llama-2-7b-chat.ggmlv3.q8_0.bin",
                      model_type="llama",
